...
esp_err_t driver_erc12864_init(void) {
  ...
  /*uint8_t initSeq[] = {
          0x2f, //Set power control (101xxx): boost on, voltage regulator on,
  voltage follower on 0xA2, //Set bias ratio (1010001x): mode 0 0xA1, //Set
  segment direction (1010000x): mirror on 0xC8, //Set COM direction (1100x---):
  mirror on 0xA7,//Set inverse display (1010011x): invert on 0x24, // 0x81, 37,
  //Set electronic volume (10000001, 00xxxxxx): contrast adjust (0~63) 0x40, //
