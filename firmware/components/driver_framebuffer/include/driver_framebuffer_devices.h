/* This file specifies the framebuffer configuration for the displays that are
 * supported. */
...
#define FB_FLUSH(buffer, eink_flags, x0, y0, x1, y1) \
  driver_ssd1306_write_part(buffer, x0, y0, x1, y1);
...
#define FB_1BPP_VERT
#define FB_FLUSH(buffer, eink_flags, x0, y0, x1, y1) \
  driver_erc12864_write_part(buffer, x0, y0, x1, y1);
#define COLOR_FILL_DEFAULT 0xFFFFFF
#define COLOR_TEXT_DEFAULT 0x000000
...
#define FB_ALPHA_ENABLED
#define FB_FLUSH(buffer, eink_flags, x0, y0, x1, y1) \
  driver_ili9341_write_partial(buffer, x0, y0, x1, y1)
#define COLOR_FILL_DEFAULT 0x000000
#define COLOR_TEXT_DEFAULT 0xFFFFFF
