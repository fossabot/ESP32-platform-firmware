...
/* Apply the orientation of the window to the provided coordinates. (the
 * provided coordinates are from the users perspective) */
...
/* Get the width and height of the framebuffer or a window, orientation
 * corrected */
