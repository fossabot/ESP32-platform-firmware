...
void driver_framebuffer_rect(Window *window,
                             ...
                             bool fill,
                             uint32_t color);
/* Draw a rectangle (filled or only the outline) from point (x, y) to point
 * (x+w, y+h) */
...
void driver_framebuffer_circle(Window *window,
                               ...
                               bool fill,
                               uint32_t color);
/* Draw a circle (filled or only the outline) at center point (x0, y0) with a
 * radius r starting at angle a0 and ending at angle a1 */
